...
[](https://arxiv.org/)
[](https://github.com/awesome-ai/awesome-visual-reasoning/stargazers)
[](https://github.com/awesome-ai/awesome-visual-reasoning/pulls)
...
|---|---|---|---|---|---|---|
| **GeoQA** | 5.8k | Geometry problem-solving with diagram understanding. | Diagram + Text | Diagram QA | [GitHub 📄](https://github.com/TAL-AI/GeoQA) | [Link 🤗](https://huggingface.co/datasets/TAL-AI/GeoQA) |
| **We-Math 2.0** | N/A | Unified MathBook system with RL-based multimodal reasoning tasks. | Image + Text | CoT, RL fine-tuning | N/A | [Link 🤗](https://huggingface.co/datasets/we-math/WeMath2.0) |
...
| **Geo170K** | \~170K | Large synthetic geometric dataset for diagram-based QA and reasoning. | Image + Text | Geometry QA | N/A | [Link 🤗](https://huggingface.co/datasets/G-LLaVA/Geo170K) |
...
| **TQA (TextbookQA)** | 26k | QA derived from textbooks combining text and diagrams. | Diagram + Text | Text + Diagram QA | [Website 🌐](https://www.google.com/search?q=httpshttps://tqa.cs.washington.edu/) | N/A |
...
| **ShapeWorld** | Variable | Synthetic shapes dataset for abstract reasoning. | Image | Description QA | [GitHub 📄](https://github.com/AlexKuhnle/ShapeWorld) | N/A |
...
| Name | Data Size | Description | Modality | Task Type | Paper Link 📄 | Hugging Face Link 🤗 |
|---|---|---|---|---|---|---|
| **ChartQA** | 20k | Reasoning over charts with natural language questions. | Chart + Text | Chart QA | [GitHub 📄](https://github.com/vis-nlp/ChartQA) | [Link 🤗](https://huggingface.co/datasets/vis-nlp/ChartQA) |
| **FigureQA** | 100k | Synthetic figure reasoning via attribute comparison. | Chart | Figure reasoning | [Website 🌐](https://datasets.maluuba.com/FigureQA) | N/A |
| **PlotQA** | 28k | Real-world plot-based QA emphasizing data reasoning. | Chart + Text | Data reasoning QA | [GitHub 📄](https://github.com/NiteshMethani/PlotQA) | N/A |
| **DVQA** | 3M | Bar chart reasoning with compositional questions. | Chart + Text | Chart QA | [Website 🌐](https://www.cs.cmu.edu/~dvqa/) | N/A |
...
| **All-Doc-VQA** | \~1M | A large-scale collection of 10 document VQA datasets, unified for instruction tuning. | Document + Text | Document VQA, Instruction tuning | N/A | [Link 🤗](https://www.google.com/search?q=httpsD://huggingface.co/datasets/HuggingFaceM4/all-doc-vqa-1m) |
...
| **RAVEN** | 70k | Abstract reasoning inspired by Raven’s Progressive Matrices. | Diagram | Abstract reasoning | [GitHub 📄](https://github.com/WellyZhang/RAVEN) | N/A |
| **I-RAVEN** | 100k | Improved RAVEN dataset with diverse pattern distributions. | Diagram | Logical reasoning | [GitHub 📄](https://github.com/zhangjiqingyun/I-RAVEN) | N/A |
...
| Name | Data Size | Description | Modality | Task Type | Paper Link 📄 | Hugging Face Link 🤗 |
|---|---|---|---|---|---|---|
| **MMR1** | Millions | Multimodal long-chain-of-thought reasoning dataset designed for SFT and RL training pipelines. | Image + Text | Long CoT QA | N/A | [Link 🤗](https://huggingface.co/datasets/MMR1) |
| **Vision-G1** | N/A | Multi-domain reasoning dataset (46 sources: math, spatial, GUI, commonsense, etc.) curated for RL-based training and evaluation. | Image + Text | Multimodal QA, RL training | [Link 📄](https://arxiv.org/abs/2410.11890) | [Link 🤗](https://huggingface.co/datasets/vision-g1) |
...
| **LLaVA-OneVision (1.5)** | 85M pretrain | Fully open LMM training framework and corpora, including pretraining and instruction datasets (OneVision-1.5 family). | Image + Text | Pretraining, Instruction tuning | N/A | [Collection 🤗](https://huggingface.co/collections/liuhaotian/llava-onevision-1.5-66f1d5e5e7c3c9a58b98600a) |
| **LLaVA-OneVision-1.5-Instruct** | Millions | Instruction-tuning subset (SFT splits) from the OneVision family for efficient multimodal instruction tuning. | Image + Text | Visual instruction tuning | N/A | [Link 🤗](https://huggingface.co/liuhaotian/LLaVA-OneVision-1.5-Instruct) |
...
| **Cambrian-10M** | \~10M | 10M multimodal instruction samples balancing visual and linguistic signals for robust instruction tuning. | Image + Text | Instruction tuning | N/A | [Link 🤗](https://huggingface.co/datasets/Cambrian-10M) |
| **MAmmoTH-VL-Instruct** | \~12M | Multimodal dataset family for visual reasoning and instruction tuning (e.g., MAmmoTH-VL-Instruct-12M). | Image + Text | Pretraining, Instruction tuning | N/A | [Link 🤗](https://huggingface.co/datasets/MMath/VL) |
| **CoSyn-400K** | 400K | Procedurally generated synthetic image–QA pairs for enhancing VQA diversity and robustness. | Synthetic Image + Text | Synthetic QA generation | N/A | [Link 🤗](https://huggingface.co/datasets/allenai/CoSyn-400K) |
...
| **LLaVA-CoT-100K** | \~100K | Dataset for training VLMs to conduct autonomous multistage reasoning (summary, visual interpretation, logical reasoning, conclusion). | Image + Text | Visual CoT, Instruction tuning | [Paper 📄](https://arxiv.org/abs/2411.10440) | [Link 🤗](https://huggingface.co/datasets/Xkev/LLaVA-CoT-100k) |
...
| **MiniGPT-4 Instruct** | \~5K | Curated instruction-following data used for the alignment stage of MiniGPT-4. | Image + Text | Visual instruction tuning | [Paper 📄](https://www.google.com/search?q=httpss://arxiv.org/abs/2304.10592) | [Link 🤗](https://www.google.com/search?q=https://huggingface.co/datasets/Vision-CAIR/minigpt_4_instruct_data) |
| **InternVL-Chat-SFT** | 590K | Instruction tuning data from the InternVL 1.5 model, covering general VQA, OCR, and reasoning. | Image + Text | Visual instruction tuning | [GitHub 📄](https://github.com/OpenGVLab/InternVL) | [Link 🤗](https://www.google.com/search?q=https://huggingface.co/datasets/OpenDataLab/InternVL-Chat-SFT-590K) |
