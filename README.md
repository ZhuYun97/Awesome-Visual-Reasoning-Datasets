...
| ------------------- | --------- | -------------------------------------------------------------------------------------------- | -------------- | ----------------------- | -------------------------------------------- | ---------------------------------------------------------------- |
| **GeoQA**           | 5.8k      | Geometry problem-solving with diagram understanding.                                         | Diagram + Text | Diagram QA              | [Paper 📄](https://arxiv.org/abs/2105.14517) | [Link 🤗](https://huggingface.co/datasets/hz2475/geoQA)          |
| **GeoQA+**          | 10k       | Extended GeoQA dataset with more complex geometry reasoning and richer annotations.          | Diagram + Text | Diagram QA              | [Paper 📄](https://aclanthology.org/2022.coling-1.130.pdf) | [Link 🤗](https://huggingface.co/datasets/Yuting6/geoqa_plus)     |
| **Geometry3K**      | 3k        | Diagram-based geometry question-answer pairs focusing on shape and relation reasoning.       | Image + Text   | Diagram QA              | [Paper 📄](https://arxiv.org/abs/2105.04165) | [Link 🤗](https://huggingface.co/datasets/hiyouga/geometry3k) |
| **GeomVerse**       | 60k       | Large-scale multimodal geometry dataset combining synthetic and human-written problems.      | Image + Text   | Geometry QA             | [Paper 📄](https://arxiv.org/abs/2312.12241) | [Link 🤗](https://storage.googleapis.com/gresearch/GeomVerseV0/GeomVerse.zip)   |
...
| **MM-MathInstruct** | 3M        | Instruction-tuning dataset for multimodal mathematical reasoning models.                     | Image + Text   | Instruction Tuning      | [Paper 📄](https://arxiv.org/pdf/2505.10557) | [Link 🤗](https://huggingface.co/datasets/MathLLMs/MM-MathInstruct)       |
| **MathV360K**       | 360k      | Multimodal dataset containing diverse math visual reasoning problems.                        | Image + Text   | Visual QA, Reasoning    | [Paper 📄](https://arxiv.org/abs/2406.17294) | [Link 🤗](https://huggingface.co/datasets/Zhiqiang007/MathV360K)   |
| **MultiMath-300K**       | 300k      | Multilingual and multimodal math reasoning dataset across algebra, geometry, and calculus.   | Image + Text   | CoT, Instruction Tuning | [Paper 📄](https://arxiv.org/abs/2409.00147) | [Link 🤗](https://huggingface.co/datasets/pengshuai-rin/multimath-300k)   |
